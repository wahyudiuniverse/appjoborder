...
function loadCharts() {
	...
	(t = getChartColorsArray("sales-forecast-chart")) &&
		...
		"" != salesForecastChart && salesForecastChart.destroy(),
		(salesForecastChart = new ApexCharts(
		...
		(t = getChartColorsArray("deal-type-charts")) &&
			...
			"" != dealTypeCharts && dealTypeCharts.destroy(),
			(dealTypeCharts = new ApexCharts(
	...
	(t = getChartColorsArray("revenue-expenses-charts")) &&
		...
		"" != revenueExpensesCharts && revenueExpensesCharts.destroy(),
		(revenueExpensesCharts = new ApexCharts(
