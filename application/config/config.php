...
|
*/
$karir_url = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
$karir_url .= "://" . $_SERVER['HTTP_HOST'];
$karir_url .= str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']);
$config['base_url'] = $karir_url;
...
$config['sess_cookie_name'] = 'karir_session';
...
$config['csrf_token_name'] = 'job_portal_cakrawala_group';
