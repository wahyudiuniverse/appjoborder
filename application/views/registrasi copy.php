...
<head>
	...
	<link rel="stylesheet" href="<?= base_url() ?>assets/libs/%40simonwep/pickr/themes/classic.min.css" /> <!-- 'classic' theme -->
	<link rel="stylesheet" href="<?= base_url() ?>assets/libs/%40simonwep/pickr/themes/monolith.min.css" /> <!-- 'monolith' theme -->
	<link rel="stylesheet" href="<?= base_url() ?>assets/libs/%40simonwep/pickr/themes/nano.min.css" /> <!-- 'nano' theme -->
...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
						...
						<div class="card-body">
							<form action="#" class="form-steps" autocomplete="off">
								...
								<div class="tab-content">
									...
									<div
										...
										<div>
												...
												<div class="col-lg-6">
													<div class="mb-3">
														...
														<select name="kota_input" id="kota_input" class="form-control dropdown-dengan-search">
															<option value="" style="text-wrap: wrap;">Pilih Provinsi Dulu</option>
														</select>
													</div>
												</div>
											</div>
											<div class="mb-3">
												<label
													class="form-label"
													for="sumber_info_input">Sumber Info <font color="#FF0000">*</font></label>
												...
												<span id='pesan_sumber_info_input'></span>
											</div>
											<div class="mb-3">
												<label
													class="form-label"
													for="interviewer_input">Bertemu Dengan <font color="#FF0000">*</font></label>
												...
												<span id='pesan_interviewer_input'></span>
											</div>
										</div>
										<div class="d-flex align-items-start gap-3 mt-4">
											<button
									...
									<div
										...
										<form class="g-3">
											<div class="row">
												<div class="mb-3">
													<label for="nik_ktp" class="form-label">NIK KTP <font color="#FF0000">*</font></label>
													<input type="text" class="form-control" placeholder="Nomor Induk Kependudukan" id="nik_ktp" value="" required>
													<input hidden type="text" class="form-control" id="lock_nik" value="0">
													<span id='pesan_nik_ktp'><small style='color:#FF0000;'>NIK tidak boleh kosong</br>NIK harus 16 Digit angka</br>Tidak boleh ada karakter lain selain angka</small></span>
												</div>
											</div>
											<div class="row">
												<div class="col-lg-6">
													<div class="mb-3">
														<label for="nama_lengkap" class="form-label">NAMA LENGKAP <font color="#FF0000">*</font></label>
														<input disabled type="text" class="form-control" placeholder="Nama Lengkap" id="nama_lengkap" value="" required>
														<span id='pesan_nama_lengkap'></span>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="mb-3">
														<label for="jenis_kelamin" class="form-label">JENIS KELAMIN <font color="#FF0000">*</font></label>
														<select disabled name="jenis_kelamin" id="jenis_kelamin" class="form-control dropdown-dengan-search" required>
														...
														<span id='pesan_jenis_kelamin'></span>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-lg-6">
													<div class="mb-3">
														<label for="tempat_lahir" class="form-label">TEMPAT LAHIR <font color="#FF0000">*</font></label>
														<input disabled type="text" class="form-control" placeholder="Tempat Lahir" id="tempat_lahir" value="" required>
														<span id='pesan_tempat_lahir'></span>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="mb-3">
														<label for="tanggal_lahir" class="form-label">TANGGAL LAHIR <font color="#FF0000">*</font></label>
														<input disabled type="text" class="form-control" placeholder="Tanggal Lahir" id="tanggal_lahir" data-provider="flatpickr" data-date-format="Y-m-d">
														<span id='pesan_tanggal_lahir'></span>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="mb-3">
													...
													<input disabled type="text" class="form-control" placeholder="Asal Kota Domisili" id="asal_kota" value="" required>
												</div>
											</div>
											<div class="row">
												<div class="mb-3">
													<label for="alamat_domisili" class="form-label">ALAMAT LENGKAP <font color="#FF0000">*</font></label>
													<textarea disabled class="form-control" id="alamat_domisili" placeholder="Alamat Domisili" rows="3" required></textarea>
													<span id='pesan_alamat_domisili'></span>
												</div>
											</div>
											<div class="row">
												<div class="mb-3">
													<label for="no_hp" class="form-label">NOMOR TELEPON / WHATSAPP <font color="#FF0000">*</font></label>
													<input disabled type="text" class="form-control" placeholder="Nomor Telepon / Whatsapp" id="no_hp" value="" required>
													<span id='pesan_no_hp'></span>
												</div>
											</div>
											<div class="row">
												<div class="col-lg-4">
													<div class="mb-3">
														<label for="nama_kondar" class="form-label">NAMA KONTAK DARURAT <font color="#FF0000">*</font></label>
														<input disabled type="text" class="form-control" placeholder="Nama Lengkap Kontak Darurat" id="nama_kondar" value="" required>
														<span id='pesan_nama_kondar'></span>
													</div>
												</div>
												<div class="col-lg-4">
													<div class="mb-3">
														<label for="hubungan_kondar" class="form-label">HUBUNGAN KONTAK DARURAT <font color="#FF0000">*</font></label>
														<select disabled name="hubungan_kondar" id="hubungan_kondar" class="form-control dropdown-dengan-search">
														...
														<span id='pesan_hubungan_kondar'></span>
                              ...
                              <option value="8" style="text-wrap: wrap;">Lainnya</option>
												...
												<div class="col-lg-4">
													<div class="mb-3">
														<label disabled for="nomor_kondar" class="form-label">NOMOR TELEPON KONTAK DARURAT <font color="#FF0000">*</font></label>
														<input disabled type="text" class="form-control" placeholder="Nomor Telepon Kontak Darurat" id="nomor_kondar" value="" required>
														<span id='pesan_nomor_kondar'></span>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="mb-3">
													...
													<select disabled name="status_nikah" id="status_nikah" class="form-control dropdown-dengan-search" required>
	...
	<script>
		function next_project() {
			...
			//inisialisasi pesan
			$('#pesan_sumber_info_input').html("");
			$('#pesan_interviewer_input').html("");
			...
			if (
				...
				var pesan_sumber_info_input = "";
				var pesan_interviewer_input = "";
				if (interviewer == "" || interviewer == "0" || interviewer == null) {
					pesan_interviewer_input = "<small style='color:#FF0000;'>Interviewer tidak boleh kosong</small>";
					$('#interviewer_input').focus();
				}
				if (sumber_info == "" || sumber_info == "0" || sumber_info == null) {
					pesan_sumber_info_input = "<small style='color:#FF0000;'>Sumber info tidak boleh kosong</small>";
					$('#sumber_info_input').focus();
				}
	...
	<!-- action kandidat input NIP, nomor tlpn dan nomor tlpn kontak darurat -->
	<script>
		$("#nik_ktp").on("keyup", function() {
	...
	<script>
		function reset_nip() {
			$("#lock_nik").val("0");
			$("#nik_ktp").prop("readonly", false);
			$('#pesan_nik_ktp').html("<small style='color:#FF0000;'>NIK tidak boleh kosong</br>NIK harus 16 Digit angka</br>Tidak boleh ada karakter lain selain angka</small>");
			$("#nik_ktp").css('background-color', 'transparent');
			$("#nik_ktp").val("");

			//disabling all attributes
			$('#nama_lengkap').prop('disabled', 'disabled');
			$("#nama_lengkap").val("");
			$('#jenis_kelamin').prop('disabled', 'disabled');
			$("#jenis_kelamin").val("").change();
			$('#tempat_lahir').prop('disabled', 'disabled');
			$("#tempat_lahir").val("");
			$('#tanggal_lahir').prop('disabled', 'disabled');
			$("#tanggal_lahir").val("");
			$('#asal_kota').prop('disabled', 'disabled');
			$("#asal_kota").val("");
			$('#alamat_domisili').prop('disabled', 'disabled');
			$("#alamat_domisili").val("");
			$('#no_hp').prop('disabled', 'disabled');
			$("#no_hp").val("");
			$('#nama_kondar').prop('disabled', 'disabled');
			$("#nama_kondar").val("");
			$('#hubungan_kondar').prop('disabled', 'disabled');
			$("#hubungan_kondar").val("").change();
			$('#nomor_kondar').prop('disabled', 'disabled');
			$("#nomor_kondar").val("");
	...
	<script>
		function next_data_diri() {
			...
			$('#pesan_tanggal_lahir').html("");
			$('#pesan_alamat_domisili').html("");
			$('#pesan_no_hp').html("");
			$('#pesan_nama_kondar').html("");
			$('#pesan_hubungan_kondar').html("");
			$('#pesan_nomor_kondar').html("");
			...
			if (
				...
				if (nomor_tlp_kontak_darurat == "" || nomor_tlp_kontak_darurat == "0" || nomor_tlp_kontak_darurat == null) {
					pesan_nomor_kondar = "<small style='color:#FF0000;'>Nomor kontak darurat tidak boleh kosong</small>";
					$('#nomor_kondar').focus();
				}
				if (hubungan_kontak_darurat == "" || hubungan_kontak_darurat == "0" || hubungan_kontak_darurat == null) {
					pesan_hubungan_kondar = "<small style='color:#FF0000;'>Hubungan kontak darurat tidak boleh kosong</small>";
					$('#hubungan_kondar').focus();
				}
				if (nama_kontak_darurat == "" || nama_kontak_darurat == "0" || nama_kontak_darurat == null) {
					pesan_nama_kondar = "<small style='color:#FF0000;'>Nama kontak darurat tidak boleh kosong</small>";
					$('#nama_kondar').focus();
				}
				if (nomor_tlp == "" || nomor_tlp == "0" || nomor_tlp == null) {
					pesan_no_hp = "<small style='color:#FF0000;'>Nomor HP / WhatsApp tidak boleh kosong</small>";
					$('#no_hp').focus();
				}
				if (alamat_domisili == "" || alamat_domisili == "0" || alamat_domisili == null) {
					pesan_alamat_domisili = "<small style='color:#FF0000;'>Alamat tidak boleh kosong</small>";
					$('#alamat_domisili').focus();
				}
				if (tanggal_lahir == "" || tanggal_lahir == "0" || tanggal_lahir == null) {
					pesan_tanggal_lahir = "<small style='color:#FF0000;'>Tanggal lahir tidak boleh kosong</small>";
					$('#tanggal_lahir').focus();
				}
				if (tempat_lahir == "" || tempat_lahir == "0" || tempat_lahir == null) {
					pesan_tempat_lahir = "<small style='color:#FF0000;'>Tempat lahir tidak boleh kosong</small>";
					$('#tempat_lahir').focus();
				}
				if (jenis_kelamin == "" || jenis_kelamin == "0" || jenis_kelamin == null) {
					pesan_jenis_kelamin = "<small style='color:#FF0000;'>Jenis kelamin tidak boleh kosong</small>";
					$('#jenis_kelamin').focus();
				}
				if (nama == "" || nama == "0" || nama == null) {
					pesan_nama_lengkap = "<small style='color:#FF0000;'>Nama tidak boleh kosong</small>";
					$('#nama_lengkap').focus();
				}
				if (nik == "" || nik == "0" || nik == null) {
				...
				// $("#nama_lengkap").css('background-color', 'transparent');
				// $('#no_hp').removeAttr('readonly');
				// $("#tanggal_lahir").removeAttr('disabled');
				// $("#nomor_kondar").removeAttr('disabled');
				// $("#no_hp").removeAttr('disabled');
				// $("#nama_lengkap").val("tes");
				// $("#jenis_kelamin").removeAttr('disabled');
