    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="container" id="container_modal_verifikasi_screening">
                        ...
                        <div hidden id="verifikasi_ktp_modal" class="row">
                            <table class="table table-striped col-md-12">
                                <tbody>
                                    <tr>
                                        <td style='width:25%'><strong>NIK/Nomor KTP</strong></td>
                                        <td style='width:75%'>
            ...
            <div class="modal-footer">
                ...
                <button onclick="cancel_verifikasi_screening()" id="cancel_verifikasi_screening" type='button' class='btn btn-danger'>Cancel Verifikasi</button>
                <button onclick="save_verifikasi_screening()" id="save_verifikasi_screening" type='button' class='btn btn-primary'>Verifikasi</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="row text text-white-50 text-center">
                <div class="col-lg-12 col-12">
                    <div class="p-2">
                        ...
                        <h1 class="text-white mb-1"><button onclick="respon_screening('terima')" id="terima_screening" type='button' class='btn btn-success col-12'>TERIMA</button></h1>
        ...
        <div>
            <div class="d-flex profile-wrapper">
                ...
                <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fs-14" data-bs-toggle="tab" href="#screening" role="tab" title="Screening">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        ?>
                                                                                            <button hidden onclick='verifikasi_dokumen("ktp")' class="btn btn-md btn-outline-success ladda-button mx-1" data-style="expand-right">Verifikasi Dokumen</button>
                                                                                        <?php } ?>
                                                                                    </td>
                                                                                </tr>
                                                                                ...
                                                                                <tr hidden>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        ?>
                                                                                            <button hidden onclick='verifikasi_dokumen("kk")' class="btn btn-md btn-outline-success ladda-button mx-1" data-style="expand-right">Verifikasi Dokumen</button>
                                                                                        <?php } ?>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        ...
                                                                        <table class="table table-borderless align-middle mb-0">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style='width:25%'>
                                                                                        <button hidden class="btn btn-md btn-outline-success ladda-button mx-1" data-style="expand-right">Save</button>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table class="table table-borderless align-middle mb-0">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style='width:75%'>
                                                                                        <a href="<?php echo base_url() . 'profile_screening/show_profile_screening/' . $id_kandidat; ?>" target="_blank"><button hidden class="btn btn-md btn-outline-success ladda-button mx-1" data-style="expand-right">Open Link</button></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style='width:50%'>
                                                                                        <select class="form-control dropdown-body" name="hasil_screening" id="hasil_screening">
                                                                                            <option value="0" style="text-wrap: wrap;">Pilih Hasil Akhir Screening</option>
                                                                                    ...
                                                                                    <td style='width:25%'>
                                                                                        <button class="btn btn-md btn-outline-success ladda-button mx-1" data-style="expand-right">Finish Screening</button>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
