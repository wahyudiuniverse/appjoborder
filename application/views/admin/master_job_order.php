	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
					...
					<div class="container" id="container_modal_JO">
						<div class="row">
							<table class="table table-striped col-md-12">
								<tbody>
									<tr>
										<td style='width:25%'><strong>PROJECT <font color="#FF0000">*</font></strong></td>
										<td style='width:75%'>
											<select name="project_input_modal" id="project_input_modal" class="form-control dropdown-JO-search">
												<option value="">Pilih Project</option>
												<?php if ($all_project == null) {
												} else { ?>
											...
											<span id='pesan_project_input_modal'></span>
										</td>
									</tr>
								</tbody>
							</table>
			...
			<div class="modal-footer">
				...
				<button onclick="save_JO()" id='button_save_JO' name='button_save_JO' type='button' class='btn btn-primary'>Save Project JO</button>
...
<div class="row">
	<div class="col-12">
		<div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
			<h4 class="mb-sm-0">Master Job Order</h4>

			<div class="page-title-right">
				<ol class="breadcrumb m-0">
					<li class="breadcrumb-item active">Master Job Order</li>
				</ol>
			</div>
		...
		<div class="card">
			<div class="card-header">
				<div class="d-flex justify-content-between align-items-center">
					<h5 class="card-title mb-0">List Rekapitulasi Data Job Order</h5>
					<button onclick="add_job_order()" id="button_add_job_order" class="btn btn-success btn-block">Add Project Job Order</button>
			...
			<div class="card-body">
				<p>
					<font color="#FF0000">Catatan: Klik add project JO jika di tabel belum ada projectnya</font>
				</p>
...
<script type="text/javascript">
	function open_detail(id_master_jo) {
		...
		window.open("<?= base_url() ?>admin/job_order/detail_jabatan_jo/" + id_master_jo, "_blank");
	}
</script>
		...
		if (
			...
			$.ajax({
				...
				success: function(response) {
					...
					window.open("<?= base_url() ?>admin/job_order/detail_jabatan_jo/" + res, "_blank");
				},
