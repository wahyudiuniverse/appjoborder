...
<head>
    ...
    <meta charset="utf-8" />
    <title>Coming Soon | PT. Onecorp</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Job Potal PT. Onecorp" name="description" />
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var e = new Date("Nov 1, 2024").getTime(),
